  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved calendar as @calendar" do
        ...
        post :create, {:calendar => { "date" => "invalid value" }}, valid_session
        assigns(:calendar).should be_a_new(Calendar)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested calendar" do
        ...
        Calendar.any_instance.should_receive(:update).with({ "date" => "2013-04-02" })
        put :update, {:id => calendar.to_param, :calendar => { "date" => "2013-04-02" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the calendar as @calendar" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Calendar.any_instance.stub(:save).and_return(false)
        put :update, {:id => calendar.to_param, :calendar => { "date" => "invalid value" }}, valid_session
        assigns(:calendar).should eq(calendar)
      end
